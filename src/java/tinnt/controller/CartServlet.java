...
public class CartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "";
        try {
            if (button.equals("Add Book to Your Card")) {
//                url = ADD_ITEM_TO_CART_CONTROLLER;
//                url = (String) MyApplicationConstants.ShoppingCartFeature.ADD_ITEM_TO_CART_CONTROLLER;
...
//                url = (String) MyApplicationConstants.ShoppingCartFeature.VIEW_CART_PAGE;
